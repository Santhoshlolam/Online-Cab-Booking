...
{   JFrame f;
    ...
    Signup()
    {
     ...
     ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("cab_booking/icons/profile.jpg"));
     Image i2=i1.getImage().getScaledInstance(105,150,Image.SCALE_DEFAULT);
